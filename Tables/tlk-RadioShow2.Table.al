/// <summary>
/// Table tlk-Radio Show 2 (ID 50249).
/// </summary>
table 50249 "tlk-Radio Show 2"
{
    Caption = 'Radio Show ';
    ...
    fields
    {
        ...
        field(10; "Radio Show Type"; Code[10]) { TableRelation = "tlk-Radio Show Type"; NotBlank = true; InitValue = 'show'; }
