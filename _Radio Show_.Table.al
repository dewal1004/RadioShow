table 50100 "Radio Show"
{
    ...
    fields
    {
        field(1; "ShowID"; Integer) { AutoIncrement = true; Editable = false; }
        field(5; "No. "; Code[20])
        {
            NotBlank = false;
        ...
        field(10; "Radio Show Type"; Code[10]) { TableRelation = "Radio Show Type"; NotBlank = true; InitValue = 'show'; }
        ...
        field(100; "Avg Listeners"; Decimal)
        {
            ...
            CalcFormula = average("Listernership Entry"."Listerner Count " where("Radio Show No. " = field("No. "), Date = field("Date Filter")));
        }
        ...
        field(120; "Advert Revenue"; Decimal)
        {
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = sum("Radio Show Entry"."Fee Amount" where("Radio Show No" = field("No. "), "Date Format" = filter(Advertisement))); //Date Format is actually Data Format, system didnt
